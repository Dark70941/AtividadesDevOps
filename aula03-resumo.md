...
### RELATÓRIO DE PROJETO DE SOFTWARE BASEADO EM TEMPLATE OPEN-SOURCE - TAREFA 03
...
**Data Limite de Entrega:** 29 de Agosto de 2026 às 23:59  
...
Este documento apresenta o relatório prático desenvolvido para a **Tarefa 03** da disciplina de Integração e Entrega Contínua (DevOps) . O objetivo consistiu na parametrização, versionamento e implantação contínua (CI/CD) de um projeto de software baseado em um template open-source.
